...
const StatusBadge = ({ status }) => {
  const map = {
    ...
    PENDING_AGREEMENT: 'bg-orange-50 text-orange-700 ring-orange-600/20',
    AGREEMENT_SIGNED: 'bg-emerald-50 text-emerald-700 ring-emerald-600/20',
    READY_FOR_GO_LIVE: 'bg-purple-50 text-purple-700 ring-purple-600/20',
    INFORMATION_REQUESTED: 'bg-pink-50 text-pink-700 ring-pink-600/20',
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          onClick={() => navigate('/admin/properties/new', { state: { resetDraft: true } })}
